...
// {Begin block 'Implementation of ResourceManager::loadGeometry' (in root '050 - A simple example - Next')}
...
// {End block 'Implementation of ResourceManager::loadGeometry' (in root '050 - A simple example - Next')}
