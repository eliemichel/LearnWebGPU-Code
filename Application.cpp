...
bool Application::InitializePipeline() {
    ...
    // {Begin block 'Define bindingLayout' (in root '039 - A first uniform - Next')}
    ...
    // {End block 'Define bindingLayout' (in root '039 - A first uniform - Next')}
...
void Application::MainLoop() {
	...
	// {Begin block 'Update uniform buffer' (in root '039 - A first uniform - Next')}
	...
	// {End block 'Update uniform buffer' (in root '039 - A first uniform - Next')}
...
bool Application::InitializeBuffers() {
	...
	// {Begin block 'Create uniform buffer' (in root '039 - A first uniform - Next')}
	...
	// {End block 'Create uniform buffer' (in root '039 - A first uniform - Next')}
	// {Begin block 'Upload uniform values' (in root '039 - A first uniform - Next')}
	float currentTime = 1.0f;
	m_queue.writeBuffer(m_uniformBuffer, 0, &currentTime, sizeof(float));
	// {End block 'Upload uniform values' (in root '039 - A first uniform - Next')}
	return true;
}
...
void Application::InitializeBindGroups() {
	...
	// {Begin block 'Setup binding' (in root '039 - A first uniform - Next')}
	...
	// {End block 'Setup binding' (in root '039 - A first uniform - Next')}
