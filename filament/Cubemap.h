...
public:
    ...
    inline Texel const& sampleAt(const glm::vec3& direction) const;
...
inline Cubemap::Texel const& Cubemap::sampleAt(const glm::vec3& direction) const {
